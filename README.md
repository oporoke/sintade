...
### In Progress
- M3 — Capture engine (Days 21–32, weeks 5–7): in progress. Framework-free `capture` package and `SourceManager` (Day 21) and `AudioMixer` with level meters (Day 22) done; `ChunkRecorder` next (Day 23).
